//Прямоугольный двумерный массив. Программа которая будет находить строку с наименьшей суммой элементов
...
{
    Console.WriteLine("Матрица не является прямоугольная");
}